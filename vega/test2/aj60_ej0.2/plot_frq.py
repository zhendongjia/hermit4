...
##########################################################################################
item0 = Gnuplot.Data(data[0], title = '', with_='boxerrorbars lc rgb "black" fillstyle pattern 2')
item_m0 = Gnuplot.Data(data_m[0], title = '', with_='boxerrorbars lc rgb "black" fillstyle pattern 2')
#item_r = Gnuplot.PlotItems.File('ap_r_f',title = '', using=' 1:2 axes x1y2')

g = Gnuplot.Gnuplot()
g('set term postscript eps solid')
g('set output "ap_nd_md.eps"')
g('set title "aj = 80, ej = 0.3"')
