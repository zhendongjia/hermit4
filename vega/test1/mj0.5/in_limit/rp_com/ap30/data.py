...
if open_3 > 0:
    f17 = open('aj_ej_af84','w')
    f22 = open('aj_ej_r_esc','w')
    f23 = open('aj_af_r','w')
    f24 = open('aj_ej_r','w')
...
#    f7.close()
    ...
    if open_3 > 0:
            for i in orbit[-1]:
                    ...
                    if i.a <= a_out and i.a>=90: 
			print >> f17, aj, ej, i.a
			print >> f23, aj, i.a, i.radius
                    if i.a > a_out: 
                            print >> f22, aj, ej, i.radius
                    print >> f24, aj, ej, i.radius
    ...
    if open_4 > 0:
            ...
            for i in orbit[-1]:
				...
				print >> f27, aj, ej, (math.log10(i.radius)+6.)*0.2
                            if (i.a - a_temp) < - 1. and i.a > 0.: 
				print >> f28, aj, ej, (math.log10(i.radius)+6.)*0.2
			    if (i.a - a_temp) < 1.0:
				print >> f29, aj, ej, (math.log10(i.radius)+6.)*0.2
			    if (i.a - a_temp ) > 1.0:
				print >> f30, aj, ej, (math.log10(i.radius)+6.)*0.2
