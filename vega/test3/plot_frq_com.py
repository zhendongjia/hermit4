...
##########################################################################################
item0 = Gnuplot.Data(data[0], title = 'with gas', with_='boxerrorbars lc rgb "black" fillstyle pattern 2')
item1 = Gnuplot.Data(data[1], title = 'no gas', with_='boxerrorbars lc rgb "black" fillstyle pattern 2')
#item_r = Gnuplot.PlotItems.File('ap_r_f',title = '', using=' 1:2 axes x1y2')

g = Gnuplot.Gnuplot()
g('set term postscript eps solid')
g('set output "ap_fr_gas.eps"')
g('set title "aj = 80, ej = 0.4"')
