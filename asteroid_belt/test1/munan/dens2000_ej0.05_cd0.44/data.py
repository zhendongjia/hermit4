...
#data_dir = range(0,500)
#data_dir = (6,14,74,85,95,27,45,82,90,129,7,15,16,21,25,310,323,333,353,360)
data_dir = [6,14,74,27,45,82,7,15,16,310,323,333]
...
if open_2 > 0:
    f9 = open('r_a0_a_e_t_e0_few','w')
    f10 = open('r_a0_dt_e0_few','w')
                    ...
                    for i in orbit:
                            ...
                            if i[j].a >= a_in and i[j].a <= a_out:
                                    ...
                                    if i[j].ecc >= e_crit and state_start == 0:
                                            ...
                                            t_stop = i[j].time
                                            state_start = 1
                                    if i[j].ecc < e_crit and state_start == 1:
                                            t_stop = i[j].time
                                            break
                                    t_temp = i[j].time
                    print >> f9
