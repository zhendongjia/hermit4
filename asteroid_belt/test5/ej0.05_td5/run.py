...
hermit_location = os.getenv('HOME')+'/Hermit4/hermit4_td5'
runfile_location = os.getenv('HOME')+'/Hermit4/asteroid_belt/test6/ej0.05_td5'
...
#radius in km unit
  ...
  #  radius = [500.]
    ...
    ecc=[0.000]*(n-2) + [ej] + [es]
    aj = 5.2
    a=[random.uniform(3.3**(-0.5), 2.3**(-0.5))**(-2)]+[aj]+ [9.55]
 #   a = [3.0, 5.2, 9.55]
