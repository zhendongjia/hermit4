...
#item0 = Gnuplot.PlotItems.File('t_assr', title = '', with_='l lt 1 lc rgb "green" lw 5' )
item1 = Gnuplot.PlotItems.File('t_assr_wg_2dep', title = '', with_='l lt 2 lc rgb "green" lw 5' )
#item2 = Gnuplot.PlotItems.File('t_assr_p4', title = '', with_='l lt 3 lc rgb "green" lw 5' )

#g._add_to_queue([item1])
