...
hermit_location = os.getenv('HOME')+'/Hermit4/hermit4_s0.5_h0.5'
runfile_location = os.getenv('HOME')+'/Hermit4/asteroid_belt/test5'
...
#radius in km unit
    ...
    ecc=[0.000]*(n-1) + [ej] 
    aj = 5.2
    a=[random.uniform(3.2**(-0.5), 2**(-0.5))**(-2)]+[aj]
    a = [3.5, 5.2]
