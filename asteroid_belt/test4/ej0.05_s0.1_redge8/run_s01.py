...
hermit_location = os.getenv('HOME')+'/Hermit4/hermit4_s0.1'
runfile_location = os.getenv('HOME')+'/Hermit4/asteroid_belt/test5/ej0.05_s0.1_redge8'
...
#    radius = [20.]
    ...
    ecc=[0.000]*(n-1) + [ej] 
    aj = 5.2
    a=[random.uniform(3.5**(-0.5), 2**(-0.5))**(-2)]+[aj]
#    a = [3.5, 5.2, 9.5]
