...
data1 = [(r, f_grav(r, 0., 0., 1)) for r in rlist]
data2 = [(r, f_grav(r, 0., 0., 2)) for r in rlist]
print data2

data3 = [(r, f_grav(r, 10*tdep[0], 10*tdep[1], 1)) for r in rlist]
data4 = [(r, f_grav(r, 10*tdep[0], 10*tdep[2], 2)) for r in rlist]

data5 = [(t, rate(3.5, t, 0)) for t in tlist]
data6 = [(t, rate(3.5, t, 1)) for t in tlist]
data7 = [(t, rate(3.5, t, 2)) for t in tlist]

data8 = [(r, f_td(r, 0., 0., 1)) for r in rlist]
data9 = [(r, f_td(r, 0., 0., 2)) for r in rlist]

data10 = [(r, f_gd(r, 0., 0., 1)) for r in rlist]
data11 = [(r, f_gd(r, 0., 0., 2)) for r in rlist]
