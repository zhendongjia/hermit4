...
hermit_location = os.getenv('HOME')+'/Hermit4/hermit4_s0.1_h0.5'
runfile_location = os.getenv('HOME')+'/Hermit4/asteroid_belt/test5/ej0.05_ws_s0.1_h0.5'
...
#radius in km unit
    ...
    for i in range(n-1):
	 if alpha > 0:
		...
		radius[i] = 10**(random.uniform(1.0,3.5))
  ...
  #  radius = [10.]
    ...
    ecc=[0.000]*(n-2) + [ej] + [es] 
    aj = 5.2
    a=[random.uniform(3.2**(-0.5), 2**(-0.5))**(-2)]+[aj]+[9.5]
 #   a = [3.5, 5.2, 9.5]
