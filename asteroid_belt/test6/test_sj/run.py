...
runfile_location = os.getenv('HOME')+'/Hermit4/asteroid_belt/test6/test_sj'
...
#radius in km unit
    ...
    mp=[dens_p*4*math.pi*(radius[i]*1e5)**3/(3*m_sun_g)] + [m_j] 
    ej = 0.05
    ecc=[0.000] + [ej] 
    print a_j*(1-ej), a_j*(1+ej)
#    a=[random.uniform(3.3**(-0.5), 2.0**(-0.5))**(-2)]+[a_j]+ [a_s]
    a = [3.5, a_j]
